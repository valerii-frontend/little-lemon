  ...
  return (
    <main className='page'>
      <div className='page__container'>
        ...
        <p>
          The <span>Little Lemon</span> it's a small, family-owned restaurant that located in a quiet, residential area.
          We known for its cozy atmosphere, friendly staff, and delicious home-style cooking.
        </p>
        <p>
        ...
        <p>
          The Little Lemon quickly became a community staple, and it was not uncommon to see regular customers catching
          up with each other over a warm meal. The owners and staff of the restaurant were well-known for their kindness
          and generosity, often donating food and hosting events to support local charities.
        </p>
        <p>
          ...
          passionate chef who loved the Little Lemon as much as they did, and sold the restaurant to him. The restaurant
          continued to thrive and bring joy to the community under the new ownership, becoming a legacy for the
          founders.
        </p>
      </div>
    </main>
